    ...
    for sample_number in benchmark_samples:
        for data_mode in ["high_variable_gene"]:
            ...
            for split_version in range(0,4):
                ...
                adata_st = adata_train.copy()
                markers = markers = list(set.intersection(set(adata_sc.var_names), set(adata_st.var_names))) # get common genes/they are all common
                ...
                adata_impute.X = copy.deepcopy(ad_ge.X)
